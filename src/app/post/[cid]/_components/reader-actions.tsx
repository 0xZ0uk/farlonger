...
export const ReaderActions: React.FC<Props> = ({
  ...
  return (
    <div className="fixed bottom-16 flex h-16 w-full items-center justify-start gap-3 rounded-none border border-b-0 bg-muted px-3 md:bottom-8 md:w-fit  md:rounded-lg md:border-b">
